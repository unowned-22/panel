                    ...
                    <DropdownMenu open={coverMenuOpen} onOpenChange={setCoverMenuOpen}>
                        <DropdownMenuTrigger asChild>
                            <button className="button-pill absolute right-5 top-5 gap-2 bg-background/80 px-4 py-2 text-sm backdrop-blur hover:bg-background/90">
                                <PenLine className="h-4 w-4" />Изменить обложку
                            </button>
                        </DropdownMenuTrigger>
                        <DropdownMenuContent align="end" className="w-56 rounded-xl border-border bg-popover p-2 shadow-elevated">
                            ...
                            >
                                <ImageIcon className="h-4 w-4 text-primary" />Загрузить изображение
                            </DropdownMenuItem>
                        </DropdownMenuContent>
                    </DropdownMenu>
                </div>
                ...
                <div className="relative flex min-h-22 items-center gap-4 bg-card px-5 py-4">
                    ...
                    <div className="ml-37 min-w-0 flex-1">
                        ...
                        <button className="mt-0.5 flex items-center gap-1 text-sm text-primary hover:underline">
                            Укажите информацию о себе <ChevronRight className="h-4 w-4" />
                        </button>
                    </div>

                    <div className="flex items-center gap-2">
                        <button className="button-pill rounded-lg px-5">Редактировать профиль</button>
                        <Link to="/analytics" className="flex h-10 w-10 items-center justify-center rounded-lg bg-secondary hover:bg-accent" aria-label="Аналитика">
                            <BarChart3 className="h-5 w-5" />
                        </Link>
                        <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                                <button className="button-pill gap-2 rounded-lg px-4">Ещё <ChevronDown className="h-4 w-4" /></button>
                            </DropdownMenuTrigger>
            ...
            <div className="flex gap-4">
                ...
                <aside className="hidden xl:flex flex-col w-70 shrink-0 gap-3 sticky top-18 self-start max-h-[calc(100vh-72px)]">
                    ...
                    <div className="panel-card p-5">
                        ...
                        <button className="button-pill mt-8 w-full gap-2"><Plus className="h-4 w-4" />Добавить друзей</button>
                    </div>
                </aside>
            </div>
            {renderAvatarDialog()}
